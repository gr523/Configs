...
xmodmap --list
xmodmap -pke
xmodmap -pke | grep volume
xmodmap -pke | grep raise
...
amixer get Master
amixer get Master | grep -En "\[[0-9][0-9]%" 
amixer get Master | grep -En "\[[0-9][0-9]%" | awk print $5
amixer get Master | grep -En "\[[0-9][0-9]%" | awk {print $5}
amixer get Master | grep -En "\[[0-9][0-9]%" | awk '{print $5}'
amixer get Master | grep -En "\[0-9][0-9]%" | awk '{print $5}'
amixer get Master | grep -En "\[0-9][0-9]%" 
...
echo -e "\e[33m$(battery)"
echo -e "\e[33m(battery)"
apt install nitrogen 
apt search picom
apt search compton
flatpak search picom
...
joplin
joplin-desktop
find /usr -iname "screenshot.sh"
cat /usr/share/doc/spectrwm/examples/screenshot.sh
find /usr -iname "screenshot.sh"
killall compton
killall
killall compton
...
cd ..
cat bash
ln -S /home/fahim/Codes/Assignments/CSE_4202 ./tmp
ln -s /home/fahim/Codes/Assignments/CSE_4202 ./tmp
ln -s /home/fahim/Codes/Assignments/CSE_4202/ ./tmp
${PATH}
echo ${PATH} > ~/path
...
env PATH
env ${PATH}
export env PATH=${PATH}:"/usr/share/applications"
env ${PATH}
...
nmcli c up Blank_ 
nmcli c down Blank_ 
sudo apt purge compton compton-conf 
...
xmodap -pke | grep -i "Audio"
xmodmap -pke | grep -i "Audio"
sudo apt install spectrwm -y
brave-browser
cd ./.config/
ls
...
cd ..
mv spectrwm/ spectr
mv spectr/spectrwm.conf .spectrwm.conf
mv spectr/ spectrwm/
cd ./spectrwm/
ls
ls -a
...
git status 
git add .;git commit -m "gitignore testing"
git revert 
...
git add .
git status 
git commit -m "gitignore testing"
git status 
touch ./.conf/viv
git status 
git add .
...
cd
git init
git@github.com:gr523/Configs.git
git -H
git remote add origin git@github.com:gr523/Configs.git
git status 
git add .
cat ./Desktop/UpdateCodes.sh 
date +'%a %b%d %Y
date +'%a %b%d %Y'
...
configs remote add origin git@github.com:gr523/Configs.git
configs status
configs add ./.config
configs status
git reset --./.config
configs reset --./.config
configs --reset ./.config
configs reset ./.config
configs status
configs add ./.config/*
...
configs reset ./.config
configs status
configs add -f ./.config/*
configs status
configs reset ./config/BraveSoftware/*
configs reset ./config/vivaldi/*
configs reset ./config/vivaldi/
configs reset ./config/vivaldi_old/*
configs status
git reset HEAD~
configs reset HEAD~
configs reset HEAD^
...
configs reflog show master
configs reset --hard HEAD@{1}
configs reset --hard HEAD
configs reset 
configs status
configs restore ./config/vivaldi
configs config --local status.showUntrackedFiles no
bash
nano .bashrc
configs config --local status.showUntrackedFiles no
